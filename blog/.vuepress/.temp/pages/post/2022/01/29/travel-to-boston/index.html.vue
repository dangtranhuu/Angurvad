...
<!-- more -->
<h2 id="申请" tabindex="-1"><a class="header-anchor" href="#申请" aria-hidden="true">#</a> 申请</h2>
...
<h3 id="toefl" tabindex="-1"><a class="header-anchor" href="#toefl" aria-hidden="true">#</a> TOEFL</h3>
...
<h3 id="gre" tabindex="-1"><a class="header-anchor" href="#gre" aria-hidden="true">#</a> GRE</h3>
...
<h3 id="结果" tabindex="-1"><a class="header-anchor" href="#结果" aria-hidden="true">#</a> 结果</h3>
<p>简单来说：</p>
<ul>
<li>
...
<h2 id="cpt-和-opt" tabindex="-1"><a class="header-anchor" href="#cpt-和-opt" aria-hidden="true">#</a> CPT 和 OPT</h2>
...
<h2 id="签证" tabindex="-1"><a class="header-anchor" href="#签证" aria-hidden="true">#</a> 签证</h2>
<p>天平向网课倾斜以后，签证就变得不是那么的迫切，半年以内签下来就行。于是我在排行程时，签证的优先级甚至放在了旅游的后面。约签证的时候大概已经过了高峰期，非常好约，点进领事馆一堆空位，不用天天去领事馆网站上蹲位置也不用上 <a href="https://tuixue.online/visa/" target="_blank" rel="noopener noreferrer">tuixue.online/visa</a>。</p>
<p>面签约在了上海梅龙镇广场，毕竟在上海待了四年所以在那里签还是更有安全感一点。不过我还是低估了静安区酒店的价格，而且虽然装修风格我很喜欢，但我从没住过房间如此小的酒店，不愧是寸土寸金的静安。</p>
<p>去之前准备了一下<a href="https://docs.qq.com/sheet/DRXRTSmlEeWJtT1RW" target="_blank" rel="noopener noreferrer">别人面签的时候被问到的问题</a>。他们说绝对不能让 VO 觉得你有移民倾向和对 AI 感兴趣，因此我决定在被问到毕业了想干啥时一口咬定我要回国写前端（我的确认真考虑过这个可能性所以也不能算瞎扯），结果 VO 啥都没问，收完材料就给我 check 了，并让我去中信银行寄护照。上海当时好像都不现场收护照，得邮寄，不过我几个在北京签的同样被 check 了的朋友都直接现场就把护照收了。</p>
<p>关于 F1 签证要带的材料：</p>
<ul>
<li>
...
<li>
<p>Academic advisor（即 <a href="https://www.bu.edu/cs/profiles/cpk/" target="_blank" rel="noopener noreferrer">cpk</a>）的简历</p>
</li>
<li>
<p>Offer</p>
</li>
...
<li>
<p>本科毕设导师（即<a href="https://sse.tongji.edu.cn/info/1206/3150.htm" target="_blank" rel="noopener noreferrer">赵姐姐</a>）的简历</p>
</li>
<li>
<p>“感兴趣的硕士导师”的简历</p>
...
<h2 id="网课" tabindex="-1"><a class="header-anchor" href="#网课" aria-hidden="true">#</a> 网课</h2>
...
<h3 id="cs-630-algorithms" tabindex="-1"><a class="header-anchor" href="#cs-630-algorithms" aria-hidden="true">#</a> CS 630 Algorithms</h3>
...
<h3 id="cs-542-machine-learning" tabindex="-1"><a class="header-anchor" href="#cs-542-machine-learning" aria-hidden="true">#</a> CS 542 Machine Learning</h3>
...
<p>快期末了有个 challenge，一个回归问题，让预测房租价格。给了你训练集和验证集，让你在不用任何 ML 或 DL 框架的前提下训个算法出来，然后交上去在没公开的测试集上跑，最后搞个拿 MSE 当指标的 leaderboard 出来。我用了半天速战速决。因为我之前用纯 Numpy 撸过一个 <a href="https://github.com/Renovamen/flint" target="_blank" rel="noopener noreferrer">toy DL 框架</a>，于是我想也没想就写了个简陋的 autograd 然后直接上 MLP，后来想想老师应该是希望你撸个传统 ML 算法出来而不是用神经网络...我没有对特征做任何预处理，我试了 PCA、normalization、feature selection，得出的结论是效果都没有不作处理好。这个结论有点离谱，因为我肉眼都能看出数据集 7000+ 维的特征里有大量的冗余。但我也没太在意这个，因为指标已经够用了，训练和推理时间也在规定范围内，而我那时候有点忙没想在 challenge 上换太多时间，所以赶紧交上去交差，没再研究特征的事儿。后来听一个用随机森林的同学说，他只用了 30+ 维特征就有了挺好看的效果，我要是只用 30+ 维特征的话效果应该非常难看。不知道是因为我的模型是 MLP，还是因为我没认真调参。</p>
...
<h3 id="cs-611-ood" tabindex="-1"><a class="header-anchor" href="#cs-611-ood" aria-hidden="true">#</a> CS 611 OOD</h3>
...
<p>再来是作业给分，会出现本来能跑的代码，grader 就是给你跑不起来，然后一言不合把 35 分 correctness and usability 扣完的情况，然后你就需要交 re-grade request，甚至去 oh 现场和 TA 对线。使用<a href="https://patorjk.com/software/taag/" target="_blank" rel="noopener noreferrer">生成器</a>生成的 ASCII art 会被判 cheating，因为“这部分代码不是你自己写的”，我听说这事儿的时候真的非常震惊。</p>
<p>半期考试的 theory 部分，我以为会考更偏向于面向对象<s>和设计模式（半期的时候还没讲设计模式）</s> 一点的东西，结果基本在扣 Java 语言本身的细节。而虽然我们一直都知道这课用的是 Java，而且课上也讲了不少关于 Java 的东西，可如你所见 Java 这个词甚至没在课名（Object-oriented Software Principles and Design）里出现过。当然我觉得这一条这也不算这门课的问题，只是我无能狂怒的偷偷吐槽。</p>
...
<h2 id="租房" tabindex="-1"><a class="header-anchor" href="#租房" aria-hidden="true">#</a> 租房</h2>
...
<p><img src="/img/in-post/2022-01-29/map-1.jpg" alt=""></p>
...
<p><img src="/img/in-post/2022-01-29/map-2.jpg" alt=""></p>
...
<h2 id="入境美国" tabindex="-1"><a class="header-anchor" href="#入境美国" aria-hidden="true">#</a> 入境美国</h2>
<p>跌宕起伏一波三折命途多舛（我知道这三个词里面起码有一个用法不对），主要是机票。</p>
<h3 id="机票" tabindex="-1"><a class="header-anchor" href="#机票" aria-hidden="true">#</a> 机票</h3>
...
<h3 id="出境体检" tabindex="-1"><a class="header-anchor" href="#出境体检" aria-hidden="true">#</a> 出境体检</h3>
...
<p>我就应该暑假一拿到签证就去体检。</p>
<h3 id="核酸" tabindex="-1"><a class="header-anchor" href="#核酸" aria-hidden="true">#</a> 核酸</h3>
...
<h3 id="飞机" tabindex="-1"><a class="header-anchor" href="#飞机" aria-hidden="true">#</a> 飞机</h3>
<p>值机的时候要出示疫苗接种证明（WHO 认证的国产疫苗只有国药和科兴，也就是说打智飞是登不了机的）和核酸证明。接种证明拿着身份证去接种点让他们开一份就行。这两样其实只有国内值机时看，美国入境的时候完全不看。值机柜台的人给了份<a href="https://www.cdc.gov/quarantine/pdf/Combined-Passenger-Attestation-Amended-Testing-Order-12-02-2021-p.pdf" target="_blank" rel="noopener noreferrer">美帝 CDC 要求入境的人填的文件</a>，告诉你在东京中转的时候填完并上交。</p>
<p>值机排队的时候看到了不少拿着乐器箱的人，盲猜是伯克利音乐学院的富豪学生，<s>他们的气质跟我们这种学计算机的有璧</s>。</p>
<p><s>日航的空乘好好看啊，我觉得她们的妆发和服装很好。</s></p>
...
<p>我：“来一个谢谢！”</p>
<p>真香。</p>
<p><s>啊我喜欢日航，如果没有疫情能放开吃的话也太幸福了。</s></p>
<h3 id="入境" tabindex="-1"><a class="header-anchor" href="#入境" aria-hidden="true">#</a> 入境</h3>
...
<p>彻底入境，顺利得有些恍惚。</p>
<p>然后我们去打 Uber，可能是第一次在洛干打 Uber 没有经验，司机到了以后我们一直没有找到他...然后订单就被取消了还扣了我们 5 美金。<s>写到这里的时候我才惊觉我忘了付打车钱给我同学，我起床以后就给嘤。</s></p>
<p>然后停车场一个老哥问我们上不上车，即使是在国内这也显得很可疑，但那天是波士顿入冬以来最冷的一天（在当时是最冷的，现在已经有更冷的了），-11 度，在寒冷的压迫下我们还是上了老哥的车。</p>
<p>老哥热情的尝试和我们聊天，但我们的听力<s>不怎么样</s>还没有适应美帝环境所以并没有怎么听懂。</p>
<h2 id="酒店" tabindex="-1"><a class="header-anchor" href="#酒店" aria-hidden="true">#</a> 酒店</h2>
<p>入境以后已经是晚上了，公寓下班了没法 check-in，而且就算 check-in 了里面也啥也没有，所以我去 <a href="https://booking.com/" target="_blank" rel="noopener noreferrer">Booking.com</a> 上定了两天酒店，用 <a href="https://www.expedia.com/" target="_blank" rel="noopener noreferrer">Expedia</a> 或者 <a href="https://www.airbnb.com/" target="_blank" rel="noopener noreferrer">Airbnb</a> 也行。</p>
<p>美国酒店和国内的一些不同：</p>
<ul>
<li>
<p>没有拖鞋</p>
...
<h2 id="购物" tabindex="-1"><a class="header-anchor" href="#购物" aria-hidden="true">#</a> 购物</h2>
...
<p>我就说美帝物流怎么会那么快。</p>
<p>所以我还是睡了几天地板。我去超市买了一块最便宜的像毯子的东西，还挺厚的，很适合铺地上睡觉。在被子到之前只能调高暖气盖着衣服睡。这样睡了几天我觉得睡地板还不错，<s>好像没有床也行</s>。</p>
<p>然后去超市买了一些生活必需品。一些中国特色的东西如酱醋老干妈饺子包子等需要去 Super88 买，Super88 离我住的地方还挺远的得坐绿线。去了两趟后发现可以网购，遂没再去过。</p>
<h2 id="吃" tabindex="-1"><a class="header-anchor" href="#吃" aria-hidden="true">#</a> 吃</h2>
...
<h2 id="行" tabindex="-1"><a class="header-anchor" href="#行" aria-hidden="true">#</a> 行</h2>
...
<h2 id="天气" tabindex="-1"><a class="header-anchor" href="#天气" aria-hidden="true">#</a> 天气</h2>
